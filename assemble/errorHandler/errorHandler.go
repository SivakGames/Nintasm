...
func AddNew(errorTableKey enumErrorCodes.Def, args ...interface{}) error {
	...
	if totalQueuedErrors+2 > ERROR_STACK_CAPACITY {
		totalQueuedErrors++
		totalErrors++
		tooManyErrorsEntry := newErrorEntry(errorTableKey, "Too many errors! Cannot continue!", enumErrorCodes.Fatal)
		tooManyErrorsEntry.fileName = "ERROR OUTPUT LIMIT REACHED"
...
func GetWarningCount() uint {
	return totalWarnings
}

func GetTotalQueuedErrorCount() uint {
