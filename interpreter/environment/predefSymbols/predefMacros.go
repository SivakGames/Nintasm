...
var builtInmacro_BackupAXY = []string{
	" PHA",
	" TXA",
	" PHA",
	" TYA",
...
var builtInmacro_RestoreAXY = []string{
	" PLA",
	" TAY",
	" PLA",
	" TAX",
...
var predefinedMacroDefinitions = []predefMacro{
	...
	newPredefMacro("__backupAXY__", &builtInmacro_BackupAXY),
	newPredefMacro("__restoreAXY__", &builtInmacro_RestoreAXY),
}
