...
func CreateMemberExpressionNode(parent string, key string, left Node, computed bool, arguments []Node) Node {
...
// ===================================================
// Multi node
func CreateArrayNode(nodes []Node) Node {
	node := newNode("\x1b[34m[Array]\x1b[0m", enumNodeTypes.Array)
...
func CreateImplicitUndefinedNode() Node {
	node := newNode("_", enumNodeTypes.ImplicitUndefined)
	node.Resolved = true
	return node
}
