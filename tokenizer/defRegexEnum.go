...
var (
	...
	directiveSpec = []specRegexEnum{
		{regexp.MustCompile(generateBoundaries("db|byte|dw|word|dwBe|wordBe")), enumTokenTypes.DIRECTIVE_dataBytes},
		...
		{regexp.MustCompile(generateBoundaries("log")), enumTokenTypes.DIRECTIVE_log},
	...
	remainingSpec = []specRegexEnum{
		//Undefined token
		{regexp.MustCompile(generateBoundaries("_")), enumTokenTypes.IMPLICIT_UNDEFINED},
