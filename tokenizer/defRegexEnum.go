...
var (
	...
	directiveSpec = []specRegexEnum{
		...
		{regexp.MustCompile(generateBoundaries("if|ikv|repeat")), enumTokenTypes.DIRECTIVE_blockStart},
		{regexp.MustCompile(generateBoundaries("elseif|ifdef|ifndef|else|switch|case|default")), enumTokenTypes.DIRECTIVE_if},
