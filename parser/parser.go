...
// When dealing with certain local labels, there may be cases where things like .a, .x etc
// should be considered to be identifiers and not other tokens.
func (p *Parser) convertIdentifierLikeLocalToIdentifier() {
